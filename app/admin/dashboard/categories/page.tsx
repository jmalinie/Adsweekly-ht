...
// Category interface'ine is_featured ekleyin
interface Category {
  id: string
  name: string
  slug: string
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b dark:border-gray-700">
                      ...
                      {/* Tablo başlıklarına Featured sütunu ekleyin */}
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                        Featured
                      </th>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    {categories.map((category) => (
                      <tr key={category.id}>
                        ...
                        {/* Kategori satırlarına Featured durumunu gösteren bir sütun ekleyin */}
                        {/* Post Count sütunundan sonra, Actions sütunundan önce */}
                        <td className="px-6 py-4 whitespace-nowrap">
